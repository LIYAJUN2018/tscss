...
var api = {
    ...
    info : {
    	...
    	// 课程管理
    	courseListData : BASE_WEB + "info/course/list/data",
    	courseEditView: BASE_WEB + 'info/course/edit',
    	courseEdit: BASE_WEB + 'info/course/edit',
        ...
        classroomRm: BASE_WEB + 'info/classroom/remove/',
        classroomRmBatch: BASE_WEB + 'info/classroom/removeBatch',
        ...
        classRm: BASE_WEB + 'info/class/remove/',
        classRmBatch: BASE_WEB + 'info/class/removeBatch',
